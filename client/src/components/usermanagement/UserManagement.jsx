...
export default function UserManagement() {
  ...
  useEffect(() => {
    dispatch(getAllUsers()); // eslint-disable-next-line
  }, []);
  ...
  return (
    <>
      ...
      <Grid
        container
        component="main"
        style={{ marginTop: "5vh", paddingBottom: "5vh" }}
      >
        <Container
          component={Paper}
          style={{ maxWidth: "95vw", minWidth: "65vw" }}
        >
                  ...
                  <TableCell className={classes.tableCell} align="center">
                    ...
                    {/* {user?.sub ? (
                      ...
                      <Button
                        variant="contained"
                        color="primary"
                        onClick={() => handleDesblock(user.sub)}
                      >
                        Desbloquear
                      </Button>
                    )} */}
