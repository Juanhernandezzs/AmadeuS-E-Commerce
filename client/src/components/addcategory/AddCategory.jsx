...
export const AddCategory = ({ history }) => {
  ...
  useEffect(() => {
    axios
      .get(`${REACT_APP_SERVER}/categories`)
      .then((response) => {
        ...
        <MaterialTable
          ...
          editable={{
            ...
            onRowDelete: (selectedRow) =>
              new Promise((resolve, reject) => {
                axios
                  .delete(`${REACT_APP_SERVER}/categories/${selectedRow._id}`, {
                    headers,
                  })
                  .then((response) => {
                    setData(
                      data.filter((elem) => elem._id !== selectedRow._id)
                    );
                    resolve();
            ...
            onRowUpdate: (updatedRow, oldRow) =>
              new Promise((resolve, reject) => {
                ...
                axios
                  .put(
                    `${REACT_APP_SERVER}/categories/${oldRow._id}`,
                    { name },
                    { headers }
                  )
                  .then((response) => {
                    let newData = data; // eslint-disable-next-line
                    newData.map((elem) => {
